...
def main():
    ...
    strategy = StrategyCurveBadgerWBtcRenBtc.at("0xF8F02D0d41C79a1973f65A440C98acAc7eAA8Dc1")
    vault = SettV3.at("0x7B6bfB88904e4B3A6d239d5Ed8adF557B22C10FC")
